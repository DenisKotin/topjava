...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    public static class PostgresImpl extends JdbcMealRepository<LocalDateTime> {

        public PostgresImpl(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    ...
    @Repository
    @Profile("hsqldb & jdbc")
    public static class HsqldbImpl extends JdbcMealRepository<Timestamp> {
        public HsqldbImpl(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
            super(jdbcTemplate, namedParameterJdbcTemplate);
        }
